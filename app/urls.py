...
from .views import (
    ProductCreate, ProductList, ProductDetail, ProductDelete, ProductUpdate,
    StockCreate, StockList, StockDetail, StockDelete, StockUpdate,
    WarehouseCreate, WarehouseList, WarehouseUpdate, WarehouseDelete, WarehouseUpdate,
    TransferStockCreate, TransferStockRetreive, TransferStockDetails , TransferStockDelete, TransferStockUpdate
)
